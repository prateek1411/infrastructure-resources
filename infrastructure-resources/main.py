...
class MyVirtualMachine(TerraformStack):
    def __init__(self, scope: Construct, ns: str):
        ...
        with open(os.path.join("Prateek-vm2.pem"), 'wb') as content_file:
            ...
            print(key_data)
        ssh_keys = VirtualMachineOsProfileLinuxConfigSshKeys(path='/home/{0}/.ssh/authorized_keys'.format(os_profile.admin_username),key_data=key_data)
        os_profile_linux_config = VirtualMachineOsProfileLinuxConfig(disable_password_authentication=True, ssh_keys=[ssh_keys])
